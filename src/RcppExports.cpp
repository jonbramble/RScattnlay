...
RcppExport SEXP _Rscattnlay_S4_SCATTNLAY_PP(SEXP fullstackSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::S4 >::type fullstack(fullstackSEXP);
    rcpp_result_gen = Rcpp::wrap(S4_SCATTNLAY_PP(fullstack));
...
static const R_CallMethodDef CallEntries[] = {
    {"_Rscattnlay_S4_SCATTNLAY_PP", (DL_FUNC) &_Rscattnlay_S4_SCATTNLAY_PP, 1},
